      ...
      <Box className={classes.infoWrapper}>
        <Box className={classes.detailPadding}>
          <Box className={classes.column}>
            <Typography>
              <h2>{props.productView && props.productView.name}</h2>
            </Typography>
            <Typography>
              <h3>{props.productView && props.productView.collection}</h3>
            </Typography>
            <Typography>
              <h4>{props.productView && props.productView.price}&nbsp;kr</h4>
            </Typography>
          </Box>
          ...
          <Box className={classes.row}>
            {textView === "Description" ? (
              <Typography>
                {props.productView && props.productView.description}
              </Typography>
            ) : null}
            {textView === "Detail" ? (
              <Typography>
                {props.productView && props.productView.details}
              </Typography>
            ) : null}
            {textView === "Care" ? (
              <Typography>
                {props.productView && props.productView.care}
              </Typography>
            ) : null}
          </Box>
        </Box>
